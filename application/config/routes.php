...
$route['(:any)/kegiatandetail/(:any)'] = 'Bkk/kegiatandetail/$1/$2';
$route['(:any)/loker'] = 'Bkk/loker/$1';
$route['(:any)/loker/(:any)'] = 'Bkk/loker/$1/$2';
$route['(:any)/lowongandetail/(:any)'] = 'Bkk/lowongandetail/$1/$2';
$route['(:any)/mitra'] = 'Bkk/mitra/$1';
$route['(:any)/mitra/(:any)'] = 'Bkk/mitra/$1/$2';
$route['(:any)/alumni'] = 'Bkk/alumni/$1';
$route['(:any)/addAlumni1'] = 'Bkk/addAlumni1/$1';
