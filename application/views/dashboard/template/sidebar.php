					...
					<li class="nav-item dropdown user-profile">
						<a href="javascript:void(0)" class="nav-link dropdown-toggle " id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<?php foreach ($profil_user as $profil) { 
								...
								<?php } else { ?>
									<img src="<?php echo base_url(); ?>assets/upload/image/user/<?= $profil->foto ?>" alt="avtar-img">
									<span class="bg-success user-status"></span>
								<?php }  
							} ?>
						</a>
						<div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
							<div class="bg-gradient px-4 py-3">
								<div class="d-flex align-items-center justify-content-between">
									<div class="mr-1">
										<?php foreach ($profil_user as $profil) { ?>
											<h4 class="text-white mb-0"><?= $profil->nama_operator ?></h4>
											<small class="text-white"><?= $profil->email ?></small>
										<?php } ?>
									</div>
						...
						<?php }else{ ?>
							...
							<li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-notepad"></i><span class="nav-title">Laporan</span></a>
								<ul aria-expanded="false">
									...
									<li> <a href='<?php echo base_url(); ?>dashboard/laporanMitraKerja'>Laporan Kemitraan</a> </li>
							...
							<div class="modal-body">
								...
								<form method="POST" id="profileForm" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control username" id="usernamea" name="username" value="<?= $profil->username ?>" required>
									</div>
									<div class="form-group">
										<label>Password</label>
										<input type="password" class="form-control password" name="password" value="" id="passworda" required="" placeholder="******" id="password" onkeyup="cek_passworda()">
										<small id="pesan_password" class="pesan_password"></small>
										<small class='text-danger password-used' id="password-used" style='display:none'>* Username dan password tidak boleh sama!</small>
										<small class='text-success password-available' id="password-available" style='display:none'>* Password bisa digunakan!</small>
									</div>
									<div class="form-group">
									...
									<div class="form-footer">
										<button type="submit" class="btn btn-success mt-4 float-right update1" id="simpan2"><span id="textSlider">Simpan</span></button>
									</div>
								</form>
							</div>
						</div>
