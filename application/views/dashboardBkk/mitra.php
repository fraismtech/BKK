        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="mitraForm" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-info mt-4" id="simpan" formaction="<?= base_url('dashboardBkk/laporan_bkk_pdf') ?>"><span id="mitraText">Export to PDF</span></button>
                        <button type="submit" class="btn btn-success mt-4" id="simpan" formaction="<?= base_url('dashboardBkk/laporan_bkk_xls') ?>"><span id="mitraText">Export to XLS</span></button>
                    </div>
                </form>
            </div>
        </div>
