                ...
                <form method="post" action="<?php echo base_url(); ?>/dashboardBkk/editAlumni" id="mitraForm" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>NISN</label>
                                <input type="text" name="nisn" class="form-control" placeholder="NISN" value="<?= $alumni->nisn ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>NIK</label>
                                <input type="text" name="nik" class="form-control" placeholder="Nomor Induk Kependudukan" value="<?= $alumni->nik ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Nama" value="<?= $alumni->nama ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="row col-lg-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="gridRadios1" value="L"  <?= $alumni->jenis_kelamin == 'L' ? ' checked="checked"' : '';?>>
                                        <label class="form-check-label" for="gridRadios1">
                                            Laki-Laki &nbsp;
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="gridRadios2" value="P" <?= $alumni->jenis_kelamin == 'P' ? ' checked="checked"' : '';?>>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Alamat</label>
                                <textarea class="form-control" name="alamat" placeholder="Alamat"><?= $alumni->alamat_alumni ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>No. telp</label>
                                <input type="number" name="no_telp" class="form-control" placeholder="No. Telp" value="<?= $alumni->no_telp ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" name="email" class="form-control" placeholder="Email" value="<?= $alumni->email ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group date form_year" data-date-format="yyyy" data-link-field="dtp_input4">
                                    <input class="form-control" type="text" placeholder="Tahun Lulus" name="tahun_lulus" value="<?= $alumni->tahun_lulus ?>">
                    ...
                    <div class="row" id="perusahaan">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control" placeholder="Nama Perusahaan" value="<?= $alumni->nama_perusahaan ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>No. Telp Perusahaan</label>
                                <input type="number" name="no_telp_perusahaan" id="no_telp_perusahaan" class="form-control" placeholder="No Telp Perusahaan" value="<?= $alumni->no_telp_perusahaan ?>">
                            </div>
                        </div>
                    </div>
